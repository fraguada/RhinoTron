...
namespace RhinoTron
{
    ...
    /// src: https://github.com/mcneel/rhino-developer-samples/blob/6/rhinocommon/cs/SampleCsEventWatcher/SampleCsEventHandlers.cs
    /// </summary>
    internal class RhinoEventHandlers
    {
        /// <summary>
        /// Private constructor
        /// </summary>
        private RhinoEventHandlers()
        {
            IsEnabled = false;
        }
        ...
        /// </summary>
        private static RhinoEventHandlers g_instance;

        /// <summary>
        /// Returns the one and only instance of this object
        /// </summary>
        public static RhinoEventHandlers Instance => g_instance ?? (g_instance = new RhinoEventHandlers());
        ...
        static StringBuilder captureCommandString = null;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="key"></param>
        private void OnKeyboardEvent(int key)
        {
            ...
            switch (key)
            {
                case 13:
                case 32:
                    captureCommandString.AppendLine(key + "," + "ENTER");
                    break;
                case 188:
                    captureCommandString.Append(", ");
                    break;
                default:
                    captureCommandString.Append(c);
                    break;
            }
        ...
        public static void OnBeginCommand(object sender, CommandEventArgs e)
        {
            ...
            captureCommandString = new StringBuilder();
            captureCommandString.AppendLine(e.CommandEnglishName);
        ...
        public static void OnEndCommand(object sender, CommandEventArgs e)
        {
            ...
            if (captureCommandString == null)
                captureCommandString = new StringBuilder();
            RhinoApp.WriteLine(captureCommandString.ToString());
        }
